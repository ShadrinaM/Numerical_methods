...
namespace C_Forms
{
    public partial class WindowLab6 : Form
    {
        ...
        private void WindowLab6_N1()
        {
            ...
            //создание панели ввода и вывода
        ...
        //    plotView.Dock = DockStyle.None; // Отключаем автоматическое растягивание
        //    plotView.Size = new Size(400, 400); // Делаем его квадратным
        //    plotView.Location = new Point((this.ClientSize.Width - plotView.Width) / 2, 10); // Центрируем по ширине
        //    plotView.Anchor = AnchorStyles.Top; // Закрепляем только сверху
        ...
        //        absErrorLabel.Text = $"Абсолютная погрешность: {Math.Round(absError, 4)}";

        //        double relError = absError / Math.PI;
        //        relErrorLabel.Text = $"Относительная погрешность: {Math.Round(relError, 4)}";
